...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 21 12:59:18 2018
...
slide = OpenSlide("/media/lwk/data/HE_Image/slides/Slide80.scn")
...
coords = pd.read_table('/media/lwk/data/HE_Image/all_users_reduced_curation_compressed.txt',delimiter='\t',
                       header =0)  
...
for i in range(n_x-1):
    for j in range(n_y-1):
        ...
        the_image.save("/media/lwk/data/HE_Image/slides/mini_data_pic/region_x{}_y{}_{}.png".format(format(i,'02d'),format(j,'02d'),format(lab_res[i,j],'02d')))
...
np.savetxt('/media/lwk/data/HE_Image/slides/slide80_mini_data.txt',dat,fmt='%i',delimiter='\t')
np.savetxt('/media/lwk/data/HE_Image/slides/slide80_mini_lab.txt',tile_lab,fmt='%i',delimiter='\t')
